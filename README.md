# Fitness Personal Project
Objective: Users will be able to fill out the required form fields to fetch their exercise sheets for the day.
...
## How to get this web app to work
1. Install "Node.js" onto whatever device you're using (e.g., laptop, desktop computer).
2. Within the "project" directory, in terminal, run the command "npm init -y". This will create the "package.json" file needed for the project.
